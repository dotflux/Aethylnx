  ...
  return (
    <div style={{ perspective: 2000 }} className="">
      ...
      <motion.div
        ...
        className="w-[426px] min-h-[400px] bg-[#18182a]/80 rounded-[30px] border-[3px] border-[#8678f9]/60 px-[40px] py-[24px] cursor-grab relative shadow-2xl backdrop-blur-xl backdrop-saturate-150"
      >
        <div className="mb-12">
          <img
            src={myLogo}
